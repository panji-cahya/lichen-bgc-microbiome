...
#SBATCH --job-name=bigslice_bacteria
#SBATCH --ntasks=1
...
cd "${analysis_dir}PAW59641_PAW59566_bacteria"
...
sqlite3 bgc/bigslice/result/data.db < ${script_dir}/main_table.sql | sed 's/|/_/g' > bacteria_bgcs_bigslice.tsv
